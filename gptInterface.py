...
def askgpt(ocrresult):
    with open(f"{script_dir}/gptlog.txt", "a+") as f:
        ...
        이러한 정보를 바탕으로 앞으로 내가 보내는 OCR된 채용공고에서 어떤 직무를 뽑는지 보고서처럼 1000자 정도로 요약해줘(내용이 별로 없으면 꼭 1000자 정도가 아니어도 돼)
        ...
        적합 여부는 판단하지마.
        다시 한번 말하지만 내가 지원하고자 하는 직무는 화학공학(화공), 환경 직무야. 전기나 기계, 영업 마케팅 같은 직무가 아니야.
        """
